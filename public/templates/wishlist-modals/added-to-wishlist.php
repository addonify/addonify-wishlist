<?php
/**
 * Modal template - Added to wishlist.
 *
...
<div class="adfy-wl-modal-content-icon">
	<?php echo apply_filters( 'addonify_wishlist_added_to_wishlist_modal_icon', addonify_wishlist_get_wishlist_icons( 'heart-2' ) ); // phpcs:ignore ?>
</div><!-- .adfy-wl-modal-content-icon -->
<div id="adfy-wl-modal-content-response">
	<p class="response-text">
		<?php echo wp_kses_post( $added_to_wishlist_text ); ?>
	</p><!-- .response-text -->
