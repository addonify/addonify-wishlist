<?php
/**
 * Modal template for displaying error message when product can not be added into the wishlist.
 *
	...
	<div class="addonify-wishlist-modal">
		...
		<div class="addonify-wishlist-modal-body">
			...
			<div id="addonify-wishlist-modal-response">
				<p class="response-text"><?php echo esc_html( addonify_wishlist_get_option( 'could_not_add_to_wishlist_error_description' ) ); ?></p>
			</div>
		</div>
	</div>
