    ...
    function addonify_wishlist_general_setting_fields() {
        ...
        return array(
            ...
            'require_login' => array(
                ...
                'description'   => __('Allow only logged-in users to add products in wishlist.', 'addonify-wishlist'),
                'dependent'     => array('enable_wishlist'),
            ...
            'redirect_to_login' => array(
                ...
                'description'   => __( 'Redirect to login if non logged-in user tries to add product in wishlist.', 'addonify-wishlist' ),
            ...
            'redirect_to_checkout_if_item_added_to_cart' => array(
                ...
                'description'   => __( 'Redirect to the checkout page if wishlist item is added to cart.', 'addonify-wishlist' ),
                'dependent'     => array('enable_wishlist'),
            ...
            'remove_from_wishlist_if_added_to_cart' => array(
                ...
                'description'   => __( 'Remove product from wishlist if it is added to cart.', 'addonify-wishlist' ),
                'dependent'     => array('enable_wishlist'),
            ...
            'cookies_lifetime' => array(
                ...
                'dependent'     => array('enable_wishlist'),
                'description'   => __( 'For how many days do you wish to save wishlist in browser cookie?', 'addonify-wsihlist' ),
    ...
    function addonify_wishlist_general_styles_settings_fields() {
        ...
        return array(
            'load_styles_from_plugin' => array(
                ...
                'description'       => __( 'If enabled, the colors selected below will be applied.', 'addonify-wishlist' ),
