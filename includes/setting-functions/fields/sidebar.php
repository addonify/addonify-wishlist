<?php
/**
 * Define settings fields for wishlist sidebar.
 *
...
if ( ! function_exists( 'addonify_wishlist_sidebar_settings_fields' ) ) {
	/**
	 * General setting fields for wishlist sidebar.
	 *
	 * @since 1.0.0
	 * @return array
	 */
...
if ( ! function_exists( 'addonify_wishlist_sidebar_modal_styles_settings_fields' ) ) {
	/**
	 * General style setting fields for wishlist sidebar.
	 *
	 * @since 1.0.0
	 * @return array
	 */
...
if ( ! function_exists( 'addonify_wishlist_sidebar_modal_toggle_button_styles_settings_fields' ) ) {
	/**
	 * Styles setting fields for buttons in wishlist sidebar.
	 *
	 * @since 1.0.0
	 * @return array
	 */
...
if ( ! function_exists( 'addonify_wishlist_product_content_styles_settings_fields' ) ) {
	/**
	 * Styles setting fields for products in wishlist sidebar.
	 *
	 * @since 1.0.0
	 * @return array
	 */
...
if ( ! function_exists( 'addonify_wishlist_sidebar_modal_notification_styles_settings_fields' ) ) {
	/**
	 * Styles setting fields for notifications in wishlist sidebar .
	 *
	 * @since 1.0.0
	 * @return array
	 */
...
if ( ! function_exists( 'addonify_wishlist_sidebar_modal_view_wishlist_button_styles_settings_fields' ) ) {
	/**
	 * Styles setting fields for view wishlist button in wishlist sidebar .
	 *
	 * @since 1.0.0
	 * @return array
	 */
